...
import ASTVarDeclVisitor from "./ASTVarDeclVisitor";
import ASTConstDeclVisitor from "./ASTConstDeclVisitor";
...
import ASTFnDeclVisitor from "./ASTFnDeclVisitor";
...
export default class Interpreter extends ASTInterpreter {
  ...
  constructor(parser: Parser, variables = {}, showDebug = false) {
    ...
    this.visitors[ASTConstDecl.name] = new ASTConstDeclVisitor(this);
    this.visitors[ASTFnDecl.name] = new ASTFnDeclVisitor(this);
    ...
    this.visitors[ASTVarDecl.name] = new ASTVarDeclVisitor(this);
